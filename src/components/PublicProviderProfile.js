...
const PublicProviderProfile = () => {
  ...
  if (error || !profile) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-slate-50 text-center px-4">
        ...
        <Link
          to="/login"
          className="text-[#009ea5] hover:text-[#008a91] font-medium transition-colors"
        >
          Go to Login
        </Link>
      </div>
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      {/* Hero */}
      <div className="bg-gradient-to-br from-[#009ea5] to-[#007a80] text-white pt-16 pb-20 px-4 text-center relative overflow-hidden">
      ...
      <div className="max-w-lg mx-auto px-4 -mt-12 pb-10 space-y-5">
              ...
              {profile.basePricing.map((item, i) => (
                <div key={i} className="px-5 py-4 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-lg bg-[#009ea5]/10 flex items-center justify-center">
                      <Clock className="w-4 h-4 text-[#009ea5]" />
                    </div>
        ...
        <div className="pt-2">
          <Link
            ...
            className="block w-full text-center bg-[#009ea5] hover:bg-[#008a91] active:bg-[#007a80] text-white font-semibold text-lg py-4 rounded-xl shadow-md hover:shadow-lg transition-all duration-200"
          >
            Book Now
          </Link>
